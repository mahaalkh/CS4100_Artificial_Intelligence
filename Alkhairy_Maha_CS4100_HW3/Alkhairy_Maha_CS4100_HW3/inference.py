        ...
        if noisyDistance is None: 
            ...
            for p in self.legalPositions:
                ...
                if emissionModel[trueDistance] > 0:
                    p_N_given_T = emissionModel[trueDistance]
                    uniform = self.beliefs[p]
                    allPossible[p] = float(p_N_given_T * uniform)
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for p in self.legalPositions:
            if self.beliefs[p] > 0: 
                ...
                for newPos, prob in newPosDist.items(): 
                    uniform = self.beliefs[p]
                    newProb = uniform * prob
                    allPossible[newPos] = allPossible[newPos] + newProb
